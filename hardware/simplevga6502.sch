...
F 1 "71256SA15" H 4750 4900 50  0000 C CNN
F 2 "Package_DIP:DIP-28_W15.24mm" H 4500 3950 50  0001 C CNN
F 3 "https://www.futurlec.com/Datasheet/Memory/62256.pdf" H 4500 3950 50  0001 C CNN
	1    4500 4050
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 60906ACB
P 8350 3350
F 0 "R1" V 8143 3350 50  0000 C CNN
F 1 "470" V 8234 3350 50  0000 C CNN
...
U 1 1 609072B1
P 8350 3700
F 0 "R2" V 8143 3700 50  0000 C CNN
F 1 "470" V 8234 3700 50  0000 C CNN
...
U 1 1 60907928
P 8350 4050
F 0 "R3" V 8143 4050 50  0000 C CNN
F 1 "470" V 8234 4050 50  0000 C CNN
...
U 1 1 609A5C81
P 9700 3350
F 0 "R7" V 9493 3350 50  0000 C CNN
F 1 "220" V 9584 3350 50  0000 C CNN
...
U 1 1 609A60F6
P 9700 3700
F 0 "R8" V 9493 3700 50  0000 C CNN
F 1 "220" V 9584 3700 50  0000 C CNN
...
U 1 1 609A6330
P 9700 4050
F 0 "R9" V 9493 4050 50  0000 C CNN
F 1 "220" V 9584 4050 50  0000 C CNN
...
U 1 1 6094E85E
P 9300 4250
F 0 "R6" H 9230 4204 50  0000 R CNN
F 1 "680" H 9230 4295 50  0000 R CNN
...
U 1 1 6094E6D5
P 9000 4250
F 0 "R5" H 8930 4204 50  0000 R CNN
F 1 "680" H 8930 4295 50  0000 R CNN
...
U 1 1 6094DFE8
P 8700 4250
F 0 "R4" H 8630 4204 50  0000 R CNN
F 1 "680" H 8630 4295 50  0000 R CNN
...
Wire Notes Line
	8450 6450 8450 4850
Text Notes 8500 6400 0    47   ~ 0
This fits on two breadboards added to a standard BE6502 build:\n\n    Board 1: X1, U1, U2, U3, U4, U5, U6\n    Board 2: U7, U8, U9, U10, U11, U12, R1..9\n\nBefore starting, remove the existing clock input from the BE6502\nand disconnect the ROM's OE signal, which BE6502 has permanently \nwired low. These will will be driven by this circuit instead.\n\nAll signals outlined in blue should be connected to corresponding\npoints on the BE6502.\n\nThe Snake game also expects VGA_V to be connected to the 6522's \nPA4 pin, and PA0..3 to be connected to active-low control buttons\n(down, up, right, left) with pull-up resistors.
