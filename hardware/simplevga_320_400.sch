...
U 1 1 6062127E
P 4500 3850
F 0 "U5" H 4350 4900 50  0000 C CNN
F 1 "AS6C4008-55PCN" H 4900 4900 50  0000 C CNN
...
Simple 320x480 VGA extension to BE6502.  The output mode is based on 640x480.  Video memory overlays \nROM and is write-only.\n\nChips specified here are the ones I've used, but aren't necessarily required, e.g. substituting HCT for AHCT might\nbe fine in some or all cases.\n\nSome VCC and GND connections have been left out to save space, but of course they should all be connected.
Text Notes 8450 6050 0    47   ~ 0
This is a further extension increasing the vertical resolution again, \nsupporting 320x400 and 320x480.\n\nAll we do is add video address bus bits VA16 and VA17 to the counter \nU3, to the RAM at U5, and add a new transceiver to pass the \nadditional address lines through from the bank register.\n\nPlease refer to the earlier schematics for more notes.\n
Entry Wire Line
	2650 4550 2750 4450
Wire Wire Line
	2750 4550 4000 4550
...
U 1 1 60ABAB77
P 3800 9300
F 0 "U?" H 3650 9750 50  0000 C CNN
F 1 "74HC243" H 4000 9750 50  0000 C CNN
F 2 "" H 3800 9300 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS243" H 3800 9300 50  0001 C CNN
	1    3800 9300
	1    0    0    -1  
$EndComp
Entry Wire Line
...
Wire Bus Line
	2950 8800 2850 8800
Text GLabel 2850 8800 0    50   Input ~ 0
BANK[0..7]
Text GLabel 3050 9500 0    50   Input ~ 0
~CPUBUS
Wire Wire Line
	3050 9500 3300 9500
Wire Wire Line
...
U 1 1 60D298E8
P 3250 9650
F 0 "#PWR?" H 3250 9400 50  0001 C CNN
...
F 1 "VCC" H 3815 8873 50  0000 C CNN
